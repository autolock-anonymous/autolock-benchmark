...
import loggerjava141.Filter;
import loggerjava141.Level;
import loggerjava141.LogManager;
...
public abstract class Handler {
    ...
    private loggerjava141.LogManager manager = LogManager.getLogManager();
    private loggerjava141.Filter filter;
    private Formatter formatter;
    private loggerjava141.Level logLevel = loggerjava141.Level.ALL;
     ...
     */
    public abstract void publish(loggerjava141.LogRecord record);
     ...
     *             the caller does not have <tt>LoggingPermission("control")</tt>.
     */
    public void setFilter(loggerjava141.Filter newFilter) throws SecurityException {
	checkAccess();
	filter = newFilter;
    }
     ...
     */
    public loggerjava141.Filter getFilter() {
	return filter;
    }
   ...
   /**
     ...
     *             the caller does not have <tt>LoggingPermission("control")</tt>.
     */
    public synchronized void setLevel(loggerjava141.Level newLevel) throws SecurityException {
	if (newLevel == null) {
	    throw new NullPointerException();
	}
	checkAccess();
