...
public class LogRecord implements Serializable {
     ...
     */
    private java141.util.logging.Level level;
     ...
     */
    public LogRecord(java141.util.logging.Level level, String msg) {
     ...
     */  
    public java141.util.logging.Level getLevel() {
	return level;
    }
    ...
    private void inferCaller() {
        ...
        String logClassName = "java141.util.logging.Logger";
