...
import java141.util.logging.Level;
import java141.util.logging.LogManager;
...
public abstract class Handler {
    ...
    private java141.util.logging.LogManager manager = LogManager.getLogManager();
    private java141.util.logging.Filter filter;
    private Formatter formatter;
    private java141.util.logging.Level logLevel = java141.util.logging.Level.ALL;
     ...
     */
    public abstract void publish(java141.util.logging.LogRecord record);
     ...
     *             the caller does not have <tt>LoggingPermission("control")</tt>.
     */
    public void setFilter(java141.util.logging.Filter newFilter) throws SecurityException {
	checkAccess();
	filter = newFilter;
    }
     ...
     */
    public java141.util.logging.Filter getFilter() {
	return filter;
    }
   ...
   /**
     ...
     *             the caller does not have <tt>LoggingPermission("control")</tt>.
     */
    public synchronized void setLevel(java141.util.logging.Level newLevel) throws SecurityException {
	if (newLevel == null) {
	    throw new NullPointerException();
	}
	checkAccess();
