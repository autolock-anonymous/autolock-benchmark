...
public class Dbcp271 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        syncTest.run();
        System.out.println("Proper synchronized version time consumed:"  + (System.currentTimeMillis() - start) + " ms");
        System.out.println("Now executing not synchronized version. It might go into an endless loop:");
        ...
        unsyncTest.run();
        System.out.println("Not synchronized version time consumed:" + (System.currentTimeMillis() - start) + " ms");
    }
}