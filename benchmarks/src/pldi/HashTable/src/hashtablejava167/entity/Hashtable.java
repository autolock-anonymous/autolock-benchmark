 ...
 * @exception IllegalArgumentException  if the initial capacity is lessthan zero, or if the load factor is nonpositive.
 */
 ...
 * @param initialCapacity   the initial capacity of the hashtable.
 * @exception IllegalArgumentException if the initial capacity is lessthan zero.
 */
 ...
 */
  ...
  /** 
 * Returns true if this hashtable maps one or more keys to this value. <p>Note that this method is identical in functionality to  {@link #contains contains} (which predates the {@link Map} interface).
 ...
 * @return  <code>true</code> if and only if the specified objectis a key in this hashtable, as determined by the <tt>equals</tt> method; <code>false</code> otherwise.
 ...
 */
  ...
  /** 
 * Returns a string representation of this <tt>Hashtable</tt> object in the form of a set of entries, enclosed in braces and separated by the ASCII characters "<tt>,&nbsp;</tt>" (comma and space). Each entry is rendered as the key, an equals sign <tt>=</tt>, and the associated element, where the <tt>toString</tt> method is used to convert the key and element to strings.
 ...
 */
  public Set<K> keySet(){
    if (keySet == null)     keySet=hashtablejava167.entity.Collections.synchronizedSet(new KeySet(),this);
    return keySet;
  }
...
synchronized (Hashtable.this) {
    ...
    public Entry<K,V> getLastReturned(){
      Cloner cloner=new Cloner();
      lastReturned=cloner.deepClone(lastReturned);
      return lastReturned;
    }
  }
...
private static class EmptyIterator implements Iterator<Object> {
  ...
  public static Iterator getEmptyIterator(){
    Cloner cloner=new Cloner();
    emptyIterator=cloner.deepClone(emptyIterator);
  ...
  public static Enumeration getEmptyEnumerator(){
    Cloner cloner=new Cloner();
    emptyEnumerator=cloner.deepClone(emptyEnumerator);
