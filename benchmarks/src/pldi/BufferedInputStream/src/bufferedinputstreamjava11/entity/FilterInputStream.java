 ...
 */
  ...
  /** 
 * Reads up to <code>len</code> bytes of data from this input stream  into an array of bytes. This method blocks until some input is  available.  <p> This method simply performs <code>in.read(b, off, len)</code>  and returns the result.
 * @param b     the buffer into which the data is read.
 ...
 */
  ...
  /** 
 * Returns the number of bytes that can be read from this input  stream without blocking.  <p> This method simply performs <code>in.available(n)</code> and returns the result.
 ...
 */
  ...
  /** 
 * Tests if this input stream supports the <code>mark</code>  and <code>reset</code> methods.  This method simply performs <code>in.markSupported()</code>.
