 ...
 */
  ...
  /** 
 * Creates a new (empty) time series. <P> By default, a daily time series is created.  Use one of the other constructors if you require a different time period.
 ...
 */
  ...
  /** 
 * Sets the domain description. <P> A property change event is fired, and an undoable edit is posted.
 ...
 */
  ...
  /** 
 * Sets the range description. <P> Registered listeners are notified of the change.
 * @param description  the new description.
 */
 ...
 */
  ...
  /** 
 * Returns the time period class for this series. <p> Only one time period class can be used within a single series (enforced). If you add a data item with a Year for the time period, then all subsequent data items must also have a Year for the time period.
 * @return the time period class for this series (null if the series is empty).
 */
  public Class getTimePeriodClass(){
    Cloner cloner=new Cloner();
    timePeriodClass=cloner.deepClone(timePeriodClass);
 ...
 */
  ...
  public String getDomain(){
    Cloner cloner=new Cloner();
    domain=cloner.deepClone(domain);
    return domain;
  }
  public static String getDEFAULT_DOMAIN_DESCRIPTION(){
    Cloner cloner=new Cloner();
    DEFAULT_DOMAIN_DESCRIPTION=cloner.deepClone(DEFAULT_DOMAIN_DESCRIPTION);
    return DEFAULT_DOMAIN_DESCRIPTION;
  }
  public static String getDEFAULT_RANGE_DESCRIPTION(){
    Cloner cloner=new Cloner();
    DEFAULT_RANGE_DESCRIPTION=cloner.deepClone(DEFAULT_RANGE_DESCRIPTION);
    return DEFAULT_RANGE_DESCRIPTION;
  }
  public String getRange(){
    Cloner cloner=new Cloner();
    range=cloner.deepClone(range);
    return range;
  }
  public List getData(){
    Cloner cloner=new Cloner();
