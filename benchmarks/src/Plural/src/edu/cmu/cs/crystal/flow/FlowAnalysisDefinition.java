...
/** 
 * Defines the transfer functions that manipulate the analysis knowledge through lattices.  Override the transfer functions of interest with the logic appropriate to your analysis.
 * @author David Dickey
 * @author Jonathan Aldrich
 * @param < LE >	the LatticeElement subclass that represents the analysis knowledge
 */
public abstract class FlowAnalysisDefinition<LE extends LatticeElement<LE>> implements ITransferFunction<LE> {
 ...
 */
  ...
  /** 
 * This method calls the correct transfer function from a generic ASTNode. TODO: Make this process cleaner
