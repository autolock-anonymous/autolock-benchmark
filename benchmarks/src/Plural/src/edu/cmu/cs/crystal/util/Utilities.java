 ...
 */
  public static MethodDeclaration getMethodDeclaration(  ASTNode node){
    while (node != null) {
      ...
      if (node.getNodeType() == ASTNode.METHOD_DECLARATION)       md=(MethodDeclaration)node;
      return md;
    }
    return null;
  }
 ...
 */
  ...
  public static MethodDeclaration getMd(){
    Cloner cloner=new Cloner();
    md=cloner.deepClone(md);
    Cloner cloner=new Cloner();
    md=cloner.deepClone(md);
    return md;
  }
  public static ASTNode getNode(){
    Cloner cloner=new Cloner();
