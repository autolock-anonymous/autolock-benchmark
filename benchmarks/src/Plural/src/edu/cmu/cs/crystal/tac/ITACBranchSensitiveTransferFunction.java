...
/** 
 * Interface for defining branch-sensitive  flow analysis transfer functions based on 3-address code instructions. Implement this interface directly or use a pre-defined abstract base classes for it.   To create a flow analysis, pass an instance of this interface to  {@link BranchInsensitiveTACAnalysis}.
