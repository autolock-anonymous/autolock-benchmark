 ...
 * @param astNode Must be a node that evaluates to a value (usually an {@link org.eclipse.jdt.core.dom.Expression}.
 ...
 */
  ...
  /** 
 * Returns the <code>this</code> variable, if the surrounding method is an  instance method.
 * @return The <code>this</code> variable, if the surrounding method is an instance method, <code>null</code> otherwise.
 */
