...
static {
  ...
  @Perm(requires="full(data) in alive",ensures="full(data) in alive") public static synchronized void storeData(  String name,  Object obj){
...
public ReentrantReadWriteLock getTime_timersLock(){
Cloner cloner=new Cloner();
