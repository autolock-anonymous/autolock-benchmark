...
@Perm(requires="share(data) * share(timers) in alive",ensures="share(data) * share(timers) in alive") public static void main(String argv[]){
...
public ReentrantReadWriteLock getData_time_timersLock(){
Cloner cloner=new Cloner();
data_time_timersLock=cloner.deepClone(data_time_timersLock);
return data_time_timersLock;
}
}
