...
public class ToResult implements java.io.Serializable {
  ...
  @Perm(requires="pure(header) in alive",ensures="pure(header) in alive") public String toString(){
    try {
  ...
  @Perm(requires="pure(volatility2) in alive",ensures="pure(volatility2) in alive") public double getVolatility2(){
    try {
      expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock.readLock().lock();
  ...
  @Perm(requires="full(volatility2) in alive",ensures="full(volatility2) in alive") public void setvolatility2(  double volatility2){
    expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock.writeLock().lock();
    this.volatility2=volatility2;
    expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock.writeLock().unlock();
  }
  @Perm(requires="pure(finalStockPrice) in alive",ensures="pure(finalStockPrice) in alive") public double getfinalStockPrice(){
    try {
      expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock.readLock().lock();
  ...
  @Perm(requires="full(finalStockPrice) in alive",ensures="full(finalStockPrice) in alive") public void setfinalStockPrice(  double finalStockPrice){
    expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock.writeLock().lock();
    this.finalStockPrice=finalStockPrice;
    expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock.writeLock().unlock();
  }
  @Perm(requires="pure(pathValue) in alive",ensures="pure(pathValue) in alive") public double[] getpathValue(){
    try {
      expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock.readLock().lock();
  ...
  public ReentrantReadWriteLock getExpectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock(){
    Cloner cloner=new Cloner();
    expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock=cloner.deepClone(expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock);
    return expectedReturnRate_finalStockPrice_header_pathValue_volatility_volatility2Lock;
  }
}
