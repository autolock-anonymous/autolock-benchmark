...
public class SeqBlackScholes {
  ...
  @Perm(requires="no permission in alive",ensures="no permission in alive") public static double callPrice(  double S,  double X,  double r,  double sigma,  double T){
  ...
  @Perm(requires="no permission in alive",ensures="no permission in alive") public static double call(  double S,  double X,  double r,  double sigma,  double T,  long N){
    double sum=0.0;
    for (int i=0; i < N; i++) {
  ...
  @Perm(requires="no permission in alive",ensures="no permission in alive") public static double call2(  double S,  double X,  double r,  double sigma,  double T,  long N){
    double sum=0.0;
    for (int i=0; i < N; i++) {
      double price=S;
      double dt=T / 10000.0;
  ...
  @Perm(requires="immutable(S) * immutable(X) * immutable(r) * immutable(sigma) * immutable(T) in alive",ensures="immutable(S) * immutable(X) * immutable(r) * immutable(sigma) * immutable(T) in alive") public static void main(  String[] args){
  ...
  public static ReentrantReadWriteLock getSLock(){
    Cloner cloner=new Cloner();
    SLock=cloner.deepClone(SLock);
    Cloner cloner=new Cloner();
    SLock=cloner.deepClone(SLock);
    return SLock;
  }
  public static ReentrantReadWriteLock getSigmaLock(){
    Cloner cloner=new Cloner();
    sigmaLock=cloner.deepClone(sigmaLock);
    Cloner cloner=new Cloner();
    sigmaLock=cloner.deepClone(sigmaLock);
    return sigmaLock;
  }
  public static ReentrantReadWriteLock getXLock(){
    Cloner cloner=new Cloner();
  ...
  public static ReentrantReadWriteLock getTLock(){
    Cloner cloner=new Cloner();
  ...
  public static ReentrantReadWriteLock getRLock(){
    Cloner cloner=new Cloner();
    rLock=cloner.deepClone(rLock);
    Cloner cloner=new Cloner();
    rLock=cloner.deepClone(rLock);
    return rLock;
  }
