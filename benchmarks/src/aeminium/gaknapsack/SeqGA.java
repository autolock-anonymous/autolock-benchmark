...
public class SeqGA {
  ...
  @Perm(requires="none(popSize) * none(numGen) * none(bestLimit) in alive",ensures="none(popSize) * none(numGen) * none(bestLimit) in alive") public static void main(  String[] args){
    Knapsack.resetSeed();
  ...
  public static ReentrantReadWriteLock getBestLimitLock(){
    Cloner cloner=new Cloner();
    bestLimitLock=cloner.deepClone(bestLimitLock);
    Cloner cloner=new Cloner();
    bestLimitLock=cloner.deepClone(bestLimitLock);
    return bestLimitLock;
  }
  public static ReentrantReadWriteLock getPopSizeLock(){
    Cloner cloner=new Cloner();
    popSizeLock=cloner.deepClone(popSizeLock);
    Cloner cloner=new Cloner();
    popSizeLock=cloner.deepClone(popSizeLock);
    return popSizeLock;
  }
  public static ReentrantReadWriteLock getNumGenLock(){
    Cloner cloner=new Cloner();
    numGenLock=cloner.deepClone(numGenLock);
    Cloner cloner=new Cloner();
    numGenLock=cloner.deepClone(numGenLock);
    return numGenLock;
  }
  public static Indiv getInd(){
    Cloner cloner=new Cloner();
    ind=cloner.deepClone(ind);
    Cloner cloner=new Cloner();
    ind=cloner.deepClone(ind);
    return ind;
  }
